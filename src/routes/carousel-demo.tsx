...
export const Route = createFileRoute('/carousel-demo')({
  head: () => ({
    meta: [
      { title: 'Coverflow Carousel Demo — Sri Subhakari Fashions' },
      {
        name: 'description',
        content: '3D Coverflow Carousel component animation demo.',
      },
    ],
  }),
  component: CarouselDemoPage,
})

function CarouselDemoPage() {
  ...
  return (
    <div className="container max-w-6xl mx-auto px-4 py-8">
      <div className="text-center max-w-2xl mx-auto mb-8">
        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground mb-3 font-heading">
          3D Coverflow Carousel
        </h1>
        <p className="text-muted-foreground text-sm sm:text-base">
          Dynamic 3D coverflow with smooth frame-based physics, touch gestures, smooth autoplay animation, and keyframe text transitions.
        </p>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          >
            {autoplay ? '✨ Autoplay ON' : '⏸️ Autoplay OFF'}
          </button>
          <button
          ...
          >
            Pagination: {showPagination ? 'ON' : 'OFF'}
          </button>
          <button
      ...
      {/* Carousel Container */}
      <div className="rounded-2xl border border-border/50 bg-card p-4 sm:p-8 shadow-sm">
        <CoverflowCarousel
          slides={SLIDES}
          autoplay={autoplay}
